        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2">
              <h1 className="text-xl font-semibold" style={{ color: '#D91A73' }}>Xác thực email</h1>
          ...
          <Card className="border-0 shadow-lg" style={{ backgroundColor: '#F2D8D8' }}>
            <CardHeader className="text-center">
              <div className="w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center" style={{ backgroundColor: '#F2A7C3' }}>
                <Mail className="w-8 h-8" style={{ color: '#D91A73' }} />
              </div>
              <CardTitle style={{ color: '#D91A73' }}>Xác thực email</CardTitle>
              <p className="text-sm opacity-80" style={{ color: '#D91A73' }}>
                Chúng tôi đã gửi mã xác thực 6 chữ số đến email
              </p>
              <p className="font-medium" style={{ color: '#D91A73' }}>
            ...
            <CardContent className="space-y-6">
              <form onSubmit={handleVerificationSubmit} className="space-y-4">
                <div className="space-y-2">
                  <Label className="text-center block" style={{ color: '#D91A73' }}>
                    Nhập mã xác thực
                  </Label>
                  <Input
              ...
              <div className="text-center space-y-3">
                {countdown > 0 ? (
                  <div className="flex items-center justify-center space-x-2 text-sm" style={{ color: '#D91A73' }}>
              ...
              <div className="p-4 rounded-lg bg-white/50">
                <div className="flex items-start space-x-2">
                  ...
                  <div className="text-xs space-y-1" style={{ color: '#D91A73' }}>
              ...
              <div className="p-4 rounded-lg bg-white/50">
                <h4 className="font-medium mb-2" style={{ color: '#D91A73' }}>Thông tin đặt phòng</h4>
              ...
              <div className="p-3 rounded-lg border-2 border-dashed" style={{ borderColor: '#F2A7C3', backgroundColor: 'rgba(242, 167, 195, 0.1)' }}>
                <p className="text-xs text-center" style={{ color: '#D91A73' }}>
