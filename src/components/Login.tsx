      ...
      <div className="sticky top-0 z-10 bg-white border-b" style={{ borderColor: '#F2D8D8' }}>
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-xl font-semibold" style={{ color: '#D91A73' }}>Đăng nhập</h1>
          </div>
        </div>
      </div>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-center justify-between text-sm">
                  <label className="flex items-center space-x-2 cursor-pointer" style={{ color: '#D91A73' }}>
                    <input type="checkbox" className="rounded" style={{ accentColor: '#D91A73' }} />
