...
export function PaymentSuccess({ bookingData, onBackToHome }: PaymentSuccessProps) {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Success Header */}
      <div className="text-center py-12" style={{ backgroundColor: 'linear-gradient(135deg, #F2D8D8 0%, #F2BBC9 50%, #F2A7C3 100%)' }}>
        <div 
        ...
        <h1 className="text-3xl md:text-4xl font-bold mb-4" style={{ color: '#D91A73' }}>
          Đặt phòng thành công!
        </h1>
        <p className="text-lg opacity-80 max-w-2xl mx-auto px-4" style={{ color: '#D91A73' }}>
          Cảm ơn bạn đã chọn KatHome In Town . Chúng tôi đã gửi email xác nhận đến địa chỉ của bạn.
        </p>
        <div className="mt-6">
          <Badge className="px-4 py-2 text-lg" style={{ backgroundColor: '#F2A7C3', color: '#D91A73' }}>
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            ...
            <Card className="border-0 shadow-lg" style={{ backgroundColor: '#F2D8D8' }}>
              ...
              <CardContent className="space-y-6">
                {/* Room Info */}
                <div>
                  <h3 className="font-semibold text-lg mb-2" style={{ color: '#D91A73' }}>
                    {bookingData.roomData.name}
                  </h3>
                  <p className="text-sm opacity-80 mb-3" style={{ color: '#D91A73' }}>
                    {bookingData.roomData.type}
                  </p>
                  <div className="flex flex-wrap gap-x-6 gap-y-2 text-sm" style={{ color: '#D91A73' }}>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    <p className="text-sm font-medium" style={{ color: '#D91A73' }}>Nhận phòng</p>
                    <p className="text-sm opacity-80 break-words" style={{ color: '#D91A73' }}>
                      {formatDate(bookingData.searchData.checkIn)}
                    </p>
                    <p className="text-xs opacity-60" style={{ color: '#D91A73' }}>Từ 14:00</p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-sm font-medium" style={{ color: '#D91A73' }}>Trả phòng</p>
                    <p className="text-sm opacity-80 break-words" style={{ color: '#D91A73' }}>
                      {formatDate(bookingData.searchData.checkOut)}
                    </p>
                    <p className="text-xs opacity-60" style={{ color: '#D91A73' }}>Trước 12:00</p>
                  </div>
                </div>

                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    <p className="text-sm font-medium" style={{ color: '#D91A73' }}>Số khách</p>
                    <p className="text-sm opacity-80" style={{ color: '#D91A73' }}>
                      {bookingData.searchData.guests} người
                    </p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-sm font-medium" style={{ color: '#D91A73' }}>Số đêm</p>
                    <p className="text-sm opacity-80" style={{ color: '#D91A73' }}>
                      {calculateNights()} đêm
                    </p>
                  </div>
                ...
                {bookingData.guestInfo.specialRequests && (
                  <div>
                    <p className="text-sm font-medium mb-2" style={{ color: '#D91A73' }}>Yêu cầu đặc biệt</p>
                    <p className="text-sm opacity-80 p-3 rounded-lg bg-white/50" style={{ color: '#D91A73' }}>
                      {bookingData.guestInfo.specialRequests}
                    </p>
                  </div>
                )}
            ...
            <div className="space-y-6">
              ...
              <Card className="border-0 shadow-lg" style={{ backgroundColor: '#F2D8D8' }}>
                ...
                <CardContent className="space-y-4">
                  <div>
                    <p className="text-sm font-medium" style={{ color: '#D91A73' }}>Họ tên</p>
                    <p className="text-sm opacity-80" style={{ color: '#D91A73' }}>
                  ...
                  <div className="space-y-4">
                    <div>
                      <p className="text-sm font-medium flex items-center space-x-1" style={{ color: '#D91A73' }}>
                        <Mail className="w-3 h-3 flex-shrink-0" />
                        <span>Email</span>
                      </p>
                      <p className="text-sm opacity-80 break-all" style={{ color: '#D91A73' }}>
              ...
              <Card className="border-0 shadow-lg" style={{ backgroundColor: '#F2D8D8' }}>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    <p className="text-sm font-medium" style={{ color: '#D91A73' }}>Phương thức thanh toán</p>
                    <p className="text-sm opacity-80 capitalize" style={{ color: '#D91A73' }}>
                  ...
                  <div>
                    <p className="text-sm font-medium" style={{ color: '#D91A73' }}>Thời gian đặt phòng</p>
                    <p className="text-sm opacity-80" style={{ color: '#D91A73' }}>
          ...
          <Card className="border-0 shadow-lg" style={{ backgroundColor: '#F2D8D8' }}>
            ...
            <CardContent>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div>
                    <h4 className="font-medium mb-2" style={{ color: '#D91A73' }}>Chính sách nhận/trả phòng</h4>
                    <ul className="text-sm space-y-1 opacity-80" style={{ color: '#D91A73' }}>
                  ...
                  <div>
                    <h4 className="font-medium mb-2" style={{ color: '#D91A73' }}>Chính sách hủy phòng</h4>
                    <p className="text-sm opacity-80" style={{ color: '#D91A73' }}>
                ...
                <div className="space-y-4">
                  <div>
                    <h4 className="font-medium mb-2" style={{ color: '#D91A73' }}>Liên hệ KatHome In Town </h4>
                    <div className="space-y-2 text-sm" style={{ color: '#D91A73' }}>
                      <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <h4 className="font-medium mb-2" style={{ color: '#D91A73' }}>Đánh giá trải nghiệm</h4>
                    <p className="text-sm opacity-80" style={{ color: '#D91A73' }}>
          ...
          <div className="text-center py-8">
            <div className="flex justify-center space-x-1 mb-4">
              {[...Array(5)].map((_, i) => (
                <Star key={i} className="w-6 h-6 fill-current" style={{ color: '#D91A73' }} />
              ))}
            </div>
            <h2 className="text-2xl font-semibold mb-4" style={{ color: '#D91A73' }}>
              Cảm ơn bạn đã chọn KatHome In Town !
            </h2>
            <p className="text-lg opacity-80 max-w-2xl mx-auto" style={{ color: '#D91A73' }}>
