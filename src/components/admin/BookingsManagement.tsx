            ...
            <table className="w-full">
              <thead>
                <tr className="border-b" style={{ borderColor: '#F2A7C3' }}>
                  ...
                  <th className="text-left p-4" style={{ color: '#C599B6' }}>Booking</th>
                  <th className="text-left p-4" style={{ color: '#C599B6' }}>Khách hàng</th>
                  <th className="text-left p-4" style={{ color: '#C599B6' }}>Phòng</th>
                  <th className="text-left p-4" style={{ color: '#C599B6' }}>Ngày</th>
                  <th className="text-left p-4" style={{ color: '#C599B6' }}>Tổng tiền</th>
                  ...
                  <tr key={booking.id} className="border-b hover:bg-white/50" style={{ borderColor: '#F2A7C3' }}>
                    ...
                    <td className="p-4">
                      <div>
                        ...
                        <div className="text-sm opacity-80 flex items-center space-x-2" style={{ color: '#C599B6' }}>
                    ...
                    <td className="p-4">
                      <div>
                        ...
                        <div className="text-sm opacity-80 flex items-center space-x-1" style={{ color: '#C599B6' }}>
